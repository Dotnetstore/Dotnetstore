...
internal sealed class UserBuilder
{
    ...
    private DateTime? BlockedDate { get; set; }
    ...
    internal UserBuilder WithBlockedDate(DateTime? blockedDate)
    {
    ...
    internal UserBuilder WithCreatedDate(DateTime createdDate)
    {
    ...
    internal UserBuilder WithLastUpdatedDate(DateTime? lastUpdatedDate)
    {
    ...
    internal UserBuilder WithDeletedDate(DateTime? deletedDate)
    {
